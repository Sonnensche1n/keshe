...
def process_traj(data_file, dname):
    data = np.load(data_file)
    data[:, -1] = np.array(data[:, -1]/60, dtype=int)
    poi = np.load('./data/' + dname.split('_')[0] + '_POI.npy')
...
if __name__ == '__main__':
    dname = 'NYC'
    part1_file = './data/NYC_part1.npy'
    part2_file = './data/NYC_part2.npy'
    process_traj(part1_file, dname + '_client1')
    process_traj(part2_file, dname + '_client2')